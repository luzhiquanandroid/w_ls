...
import com.qysd.lawtree.lawtreefragment.ShengChanTaskManager.TaskCompletFragment;
import com.qysd.lawtree.lawtreefragment.ShengChanTaskManager.TaskNoOptionFragment;
...
public class TaskManagerActivity extends BaseActivity {
    ...
    private String[] orderType = {"待处理", "已完成"};
    ...
    protected void initView() {
        initTitle(R.drawable.ic_left_jt, "任务管理", "筛选");
        ...
        window = new CommonPopupWindow(this, R.layout.pop_all_xs_layout, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT) {
            ...
            protected void initEvent() {
                ...
                tv_query.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        EventBus.getDefault().post(new ShenChanTaskEventBusBean(
                                currentItem,
    ...
    private void initFragment() {
        scPlanFragments.add(new TaskNoOptionFragment());
        scPlanFragments.add(new TaskCompletFragment());
        // ViewPager设置适配器
                ...
                if (type.equals("startTime")) {
                    ...
                    if (startDate != null & endDate != null) {
                        if (endDate.getTime() < startDate.getTime()) {
                            Toast.makeText(TaskManagerActivity.this, "开始时间不能大于结束时间", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                    ...
                    if (startDate != null & endDate != null) {
                        if (endDate.getTime() < startDate.getTime()) {
                            Toast.makeText(TaskManagerActivity.this, "结束时间不能小于开始时间", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
