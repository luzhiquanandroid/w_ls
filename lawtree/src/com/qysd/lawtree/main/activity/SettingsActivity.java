...
import com.qysd.lawtree.jsbridge.JsBridgeActivity;
import com.qysd.lawtree.main.adapter.SettingsAdapter;
import com.qysd.lawtree.main.model.SettingTemplate;
import com.qysd.lawtree.main.model.SettingType;
...
public class SettingsActivity extends UI implements SettingsAdapter.SwitchChangeListener {
    ...
    private void initUI() {
        ...
        tv_title.setText("设置");
        findViewById(R.id.linear_comment_back).setOnClickListener(new View.OnClickListener() {
            @Override
