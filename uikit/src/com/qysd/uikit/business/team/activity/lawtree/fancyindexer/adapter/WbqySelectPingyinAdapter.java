package com.qysd.uikit.business.team.activity.lawtree.fancyindexer.adapter;
...
public abstract class WbqySelectPingyinAdapter<T> extends BaseExpandableListAdapter {
    ...
    public static HashMap<String, Integer> newIsSelected;

    public WbqySelectPingyinAdapter(ExpandableListView listView, List<T> list, int layoutChildId) {
        ...
        newIsSelected = new HashMap<String, Integer>();
        for (int i = 0; i < list.size(); i++) {
            SelectPersonBean.Status a = (SelectPersonBean.Status) list.get(i);
            newIsSelected.put(a.getUserId(), 1);
        }
    ...
    public WbqySelectPingyinAdapter setContext(Context context) {
    ...
    public WbqySelectPingyinAdapter setKeyMapList(PinyinKeyMapList<T> keyMapList) {
