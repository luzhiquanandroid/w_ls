...
public abstract class MqySelectPingyinAdapter<T> extends BaseExpandableListAdapter {
    ...
    public MqySelectPingyinAdapter(ExpandableListView listView, List<T> list, int layoutChildId) {
    ...
    public MqySelectPingyinAdapter setContext(Context context) {
    ...
    public MqySelectPingyinAdapter setKeyMapList(PinyinKeyMapList<T> keyMapList) {
