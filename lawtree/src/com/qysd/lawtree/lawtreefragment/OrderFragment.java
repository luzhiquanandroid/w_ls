...
import com.qysd.lawtree.lawtreeadapter.OrderAdapter;
...
public class OrderFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadData(int state, String startTime, String endTime, String materName, String orderCodeNick) {
        ...
        GetBuilder postFormBuilder = OkHttpUtils.get()
                .url(Constants.baseUrl + "/purchaseOrder/selectPurchaseOrderList");
        ...
        postFormBuilder.build()
                .execute(new UserCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        shenChanPlanBean = gson.fromJson(response.toString(), OrderBean.class);
    ...
    private void setAdapter(final List<OrderBean.Status> list) {
        manager = new LinearLayoutManager(getActivity());
        orderRecyclerView.setLayoutManager(manager);
        scPlanAdapter = new OrderAdapter(list);
        orderRecyclerView.setAdapter(scPlanAdapter);
        //条目点击接口
        scPlanAdapter.setOnItemClickListener(new OrderAdapter.OnRecyclerViewItemClickListener() {
            @Override
