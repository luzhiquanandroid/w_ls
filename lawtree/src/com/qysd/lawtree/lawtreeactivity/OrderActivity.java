...
import com.qysd.lawtree.lawtreefragment.OrderFragment;
...
public class OrderActivity extends BaseActivity {
    ...
    private void initFragment() {
        scPlanFragments.add(new OrderFragment("0"));
        scPlanFragments.add(new OrderFragment("1"));
        // ViewPager设置适配器
                ...
                if (type.equals("startTime")) {
                    ...
                    if (startDate != null & endDate != null) {
                        if (endDate.getTime() < startDate.getTime()) {
                            Toast.makeText(OrderActivity.this, "开始时间不能大于结束时间", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                    ...
                    if (startDate != null & endDate != null) {
                        if (endDate.getTime() < startDate.getTime()) {
                            Toast.makeText(OrderActivity.this, "结束时间不能小于开始时间", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
