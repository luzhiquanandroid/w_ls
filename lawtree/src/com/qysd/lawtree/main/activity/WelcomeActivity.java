...
public class WelcomeActivity extends UI {
    ...
    private void showSplashView() {
        ...
        boolean isFirstEntery = (boolean) GetUserInfo.getData(WelcomeActivity.this, "isFirstEntery", true);
        Log.e("---isFirstEntery", isFirstEntery + "");
        if (isFirstEntery) {
    ...
    private void showMainActivity(Intent intent) {
        MainActivity3.start(WelcomeActivity.this, intent);
        //BottomTabLayoutActivity.start(WelcomeActivity.this, intent);
        finish();
    }
    public static void setIsFist(boolean bool) {
        firstEnter = bool;
    }
}
