package com.qysd.uikit.common.util.media;
...
import com.qysd.uikit.business.session.viewholder.MsgViewHolderThumbBase;
...
public class ImageUtil {
    ...
    public static Boolean scaleImage(File srcFile, File dstFile, int dstMaxWH, CompressFormat compressFormat, int quality) {
        ...
        try {
            ...
            float rotate;
            String mimeType = com.qysd.uikit.common.media.picker.util.BitmapUtil.getImageType(srcFile.getAbsolutePath());
