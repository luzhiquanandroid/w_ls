...
public class MyQiYeThreeActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void initView() {
        ...
        ll_show_one.setVisibility(View.VISIBLE);
        ll_show_two.setVisibility(View.GONE);
    ...
    private void loadData() {
        ...
        OkHttpUtils.get().url(Constants.baseUrl + "company/selectDepartAndUser")
            ...
            public void onResponse(String response, int id) {
                LoadDialog.dismiss(MyQiYeThreeActivity.this);
        ...
        myQiyeAdapter.setOnItemClickListener(new MyQiyeAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position, String type) {
                ...
                if ("BOTTOM".equals(type)) {
                    intent = new Intent(MyQiYeThreeActivity.this, LianXiRenDetailActivity.class);
