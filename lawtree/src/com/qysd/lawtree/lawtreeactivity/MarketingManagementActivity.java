...
import com.qysd.lawtree.lawtreefragment.MarketingManagement1Fragment;
...
public class MarketingManagementActivity extends BaseActivity {
    ...
    protected void initView() {
        initTitle(R.drawable.ic_left_jt, "销单管理", "筛选");
        tv_title_right = findViewById(R.id.tv_title_right);
        mViewPager = findViewById(R.id.mViewPager);
        mTabLayout = findViewById(R.id.mTabLayout);

        window = new CommonPopupWindow(this, R.layout.pop_xiaodan_layout, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT) {
            @Override
            protected void initView() {
    ...
    private void initFragment() {
        scPlanFragments.add(new MarketingManagement1Fragment("0"));
        scPlanFragments.add(new MarketingManagement1Fragment("1"));
        // ViewPager设置适配器
                ...
                if (type.equals("startTime")) {
                    ...
                    if (startDate != null & endDate != null) {
                        if (endDate.getTime() < startDate.getTime()) {
                            Toast.makeText(MarketingManagementActivity.this, "开始时间不能大于结束时间", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                    ...
                    if (startDate != null & endDate != null) {
                        if (endDate.getTime() < startDate.getTime()) {
                            Toast.makeText(MarketingManagementActivity.this, "结束时间不能小于开始时间", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
