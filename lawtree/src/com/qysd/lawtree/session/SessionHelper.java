package com.qysd.lawtree.session;
...
import com.qysd.avchatkit.TeamAVChatProfile;
import com.qysd.lawtree.DemoCache;
import com.qysd.lawtree.R;
import com.qysd.lawtree.contact.activity.RobotProfileActivity;
import com.qysd.lawtree.lawtreeactivity.LianXiRenDetailActivity;
import com.qysd.lawtree.redpacket.NIMRedPacketClient;
import com.qysd.lawtree.session.action.AVChatAction;
import com.qysd.lawtree.session.action.FileAction;
import com.qysd.lawtree.session.action.GuessAction;
import com.qysd.lawtree.session.action.RTSAction;
import com.qysd.lawtree.session.action.RedPacketAction;
import com.qysd.lawtree.session.action.SnapChatAction;
import com.qysd.lawtree.session.action.TeamAVChatAction;
import com.qysd.lawtree.session.action.TipAction;
import com.qysd.lawtree.session.activity.MessageHistoryActivity;
import com.qysd.lawtree.session.activity.MessageInfoActivity;
import com.qysd.lawtree.session.extension.CustomAttachParser;
import com.qysd.lawtree.session.extension.CustomAttachment;
import com.qysd.lawtree.session.extension.GuessAttachment;
import com.qysd.lawtree.session.extension.NewOrderChatAttachment;
import com.qysd.lawtree.session.extension.RTSAttachment;
import com.qysd.lawtree.session.extension.RedPacketAttachment;
import com.qysd.lawtree.session.extension.RedPacketOpenedAttachment;
import com.qysd.lawtree.session.extension.SnapChatAttachment;
import com.qysd.lawtree.session.extension.StickerAttachment;
import com.qysd.lawtree.session.search.SearchMessageActivity;
import com.qysd.lawtree.session.viewholder.MsgViewHolderAVChat;
import com.qysd.lawtree.session.viewholder.MsgViewHolderDefCustom;
import com.qysd.lawtree.session.viewholder.MsgViewHolderFile;
import com.qysd.lawtree.session.viewholder.MsgViewHolderGuess;
import com.qysd.lawtree.session.viewholder.MsgViewHolderNewOrder;
import com.qysd.lawtree.session.viewholder.MsgViewHolderOpenRedPacket;
import com.qysd.lawtree.session.viewholder.MsgViewHolderRTS;
import com.qysd.lawtree.session.viewholder.MsgViewHolderRedPacket;
import com.qysd.lawtree.session.viewholder.MsgViewHolderSnapChat;
import com.qysd.lawtree.session.viewholder.MsgViewHolderSticker;
import com.qysd.lawtree.session.viewholder.MsgViewHolderTip;
import com.qysd.uikit.api.NimUIKit;
import com.qysd.uikit.api.model.recent.RecentCustomization;
import com.qysd.uikit.api.model.session.SessionCustomization;
import com.qysd.uikit.api.model.session.SessionEventListener;
import com.qysd.uikit.api.wrapper.NimMessageRevokeObserver;
...
import com.qysd.uikit.business.session.module.MsgForwardFilter;
import com.qysd.uikit.business.session.module.MsgRevokeFilter;
import com.qysd.uikit.business.session.viewholder.MsgViewHolderUnknown;
import com.qysd.uikit.business.team.model.TeamExtras;
import com.qysd.uikit.business.team.model.TeamRequestCode;
import com.qysd.uikit.common.ui.dialog.EasyAlertDialogHelper;
import com.qysd.uikit.common.ui.popupmenu.NIMPopupMenu;
import com.qysd.uikit.common.ui.popupmenu.PopupMenuItem;
import com.qysd.uikit.common.util.sys.TimeUtil;
import com.qysd.uikit.impl.customization.DefaultRecentCustomization;
...
//            p2pCustomization.backgroundUri = "android.resource://com.netease.nim.demo/drawable/bk"
            ...
            infoButton.iconId = R.drawable.ic_p2p_info;
...
//            p2pCustomization.backgroundUri = "android.resource://com.netease.nim.demo/drawable/bk"
    ...
    private static void registerViewHolders() {
        ...
        NimUIKit.registerMsgItemViewHolder(NewOrderChatAttachment.class, MsgViewHolderNewOrder.class);
    ...
    private static void setSessionListener() {
        SessionEventListener listener = new SessionEventListener() {
            ...
            public void onAvatarClicked(Context context, IMMessage message) {
                ...
                intent.putExtra("account", message.getFromAccount());
