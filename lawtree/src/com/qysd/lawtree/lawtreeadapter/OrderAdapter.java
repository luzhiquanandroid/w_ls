...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.ViewHoder> {
    private List<OrderBean.Status> list = new ArrayList<>();//约见集合

    public OrderAdapter(List<OrderBean.Status> list) {
        this.list = list;
    }

    @Override
    public OrderAdapter.ViewHoder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHoder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_marketingmanagerment, parent, false));
    }

    @Override
    public void onBindViewHolder(OrderAdapter.ViewHoder holder, int position) {
    ...
    public class ViewHoder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setData(List<OrderBean.Status> list, final int position) {
