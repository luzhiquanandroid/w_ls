package com.qysd.lawtree.appupdate;
...
/**
 * Created by QYSD_GT on 2017/4/27.
 */
...
public class UpdateDemo extends BaseActivity {
    ...
    protected void bindView() {
        setContentView(R.layout.activity_updatedemo);
        initDatas();
    }
...
//        });
    ...
    public void forceUpdateDialogClick(View view) {
        ...
        if (mCheckUpdateInfo.getIsForceUpdate() == 0) {
            mForceUpdateDialog = new ForceUpdateDialog(UpdateDemo.this);
    ...
    public void UpdateDialogClick(View view) {
        ...
        if (mCheckUpdateInfo.getIsForceUpdate() == 1) {
            mUpdateDialog = new UpdateDialog(UpdateDemo.this);
