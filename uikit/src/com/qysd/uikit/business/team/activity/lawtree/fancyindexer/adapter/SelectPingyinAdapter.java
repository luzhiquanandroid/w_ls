...
public abstract class SelectPingyinAdapter<T> extends BaseExpandableListAdapter {
    ...
    public SelectPingyinAdapter(ExpandableListView listView, List<T> list, int layoutChildId) {
    ...
    public SelectPingyinAdapter setContext(Context context) {
    ...
    public SelectPingyinAdapter setKeyMapList(PinyinKeyMapList<T> keyMapList) {
