...
public class TeamCreateHelper {
    ...
    public static void createNormalTeam(final Context context, List<String> memberAccounts, final boolean isNeedBack, final RequestCallback<CreateTeamResult> callback) {
        ...
        //DialogMaker.showProgressDialog(context, context.getString(com.qysd.uikit.R.string.empty), true);
                ...
                new RequestCallback<CreateTeamResult>() {
                    ...
                    public void onSuccess(CreateTeamResult result) {
                        ...
                        if (failedAccounts != null && !failedAccounts.isEmpty()) {
                            ...
                            Toast.makeText(DemoCache.getContext(), com.qysd.uikit.R.string.create_team_success, Toast.LENGTH_SHORT).show();
                        }
                    ...
                    public void onFailed(int code) {
                        ...
                        LoadDialog.dismiss(context);
                        if (code == 801) {
                            String tip = context.getString(com.qysd.uikit.R.string.over_team_member_capacity, DEFAULT_TEAM_CAPACITY);
                            Toast.makeText(DemoCache.getContext(), tip,
                                    Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(DemoCache.getContext(), com.qysd.uikit.R.string.create_team_failed,
                                    Toast.LENGTH_SHORT).show();
                        }
     ...
     * 创建高级群
     */
    public static void createAdvancedTeam(final Context context, List<String> memberAccounts, String name) {
        String teamName;
        if ("".equals(name)) {
            teamName = "高级群";
        } else {
                ...
                setCallback(
                        new RequestCallback<CreateTeamResult>() {
                            ...
                            public void onFailed(int code) {
                                ...
                                String tip;
                                if (code == 801) {
                                    tip = context.getString(com.qysd.uikit.R.string.over_team_member_capacity,
                                            DEFAULT_TEAM_CAPACITY);
                                } else if (code == 806) {
                                    tip = context.getString(com.qysd.uikit.R.string.over_team_capacity);
                                } else {
                                    tip = context.getString(com.qysd.uikit.R.string.create_team_failed) + ", code=" +
                                            code;
                                }
