...
import com.qysd.avchatkit.teamavchat.activity.TeamAVChatActivity;
...
public class TeamAVChatAction extends AVChatAction {
    ...
    private ContactSelectActivity.Option getContactSelectOption(String teamId) {
        ...
        option.title = NimUIKit.getContext().getString(com.qysd.uikit.R.string.invite_member);
        option.maxSelectedTip = NimUIKit.getContext().getString(com.qysd.uikit.R.string.reach_capacity);
