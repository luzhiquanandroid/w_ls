package com.qysd.uikit.business.session.viewholder.robot;
...
import com.qysd.uikit.business.robot.model.RobotBotContent;
import com.qysd.uikit.business.robot.model.RobotResponseContent;
import com.qysd.uikit.business.robot.parser.elements.base.Element;
import com.qysd.uikit.business.robot.parser.elements.element.ImageElement;
import com.qysd.uikit.business.robot.parser.elements.element.TextElement;
import com.qysd.uikit.business.robot.parser.elements.group.LinkElement;
import com.qysd.uikit.business.robot.parser.elements.group.TemplateRoot;
...
public class RobotContentLinearLayout extends LinearLayout {
    ...
    private void convertTemplateToViews(final TemplateRoot template, final ClickableChildView robot) {
        List<com.qysd.uikit.business.robot.parser.elements.group.LinearLayout> robotLinearLayouts = template.getElements();
        if (robotLinearLayouts == null) {
            return;
        }
        for (com.qysd.uikit.business.robot.parser.elements.group.LinearLayout robotLinearLayout : robotLinearLayouts) {
