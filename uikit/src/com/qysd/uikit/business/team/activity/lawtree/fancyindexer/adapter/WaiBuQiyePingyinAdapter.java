...
public abstract class WaiBuQiyePingyinAdapter<T> extends BaseExpandableListAdapter {
    ...
    public WaiBuQiyePingyinAdapter(ExpandableListView listView, List<T> list, int layoutChildId) {
    ...
    public WaiBuQiyePingyinAdapter setContext(Context context) {
    ...
    public WaiBuQiyePingyinAdapter setKeyMapList(PinyinKeyMapList<T> keyMapList) {
