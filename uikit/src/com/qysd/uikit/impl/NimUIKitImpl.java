...
import com.qysd.uikit.api.UIKitInitStateListener;
import com.qysd.uikit.api.UIKitOptions;
import com.qysd.uikit.api.model.chatroom.ChatRoomMemberChangedObservable;
import com.qysd.uikit.api.model.chatroom.ChatRoomProvider;
import com.qysd.uikit.api.model.chatroom.ChatRoomSessionCustomization;
import com.qysd.uikit.api.model.contact.ContactChangedObservable;
import com.qysd.uikit.api.model.contact.ContactEventListener;
import com.qysd.uikit.api.model.contact.ContactProvider;
import com.qysd.uikit.api.model.location.LocationProvider;
import com.qysd.uikit.api.model.main.CustomPushContentProvider;
import com.qysd.uikit.api.model.main.LoginSyncDataStatusObserver;
import com.qysd.uikit.api.model.main.OnlineStateChangeObservable;
import com.qysd.uikit.api.model.main.OnlineStateContentProvider;
import com.qysd.uikit.api.model.recent.RecentCustomization;
import com.qysd.uikit.api.model.robot.RobotInfoProvider;
import com.qysd.uikit.api.model.session.SessionCustomization;
import com.qysd.uikit.api.model.session.SessionEventListener;
import com.qysd.uikit.api.model.team.TeamChangedObservable;
import com.qysd.uikit.api.model.team.TeamProvider;
import com.qysd.uikit.api.model.user.IUserInfoProvider;
import com.qysd.uikit.api.model.user.UserInfoObservable;
import com.qysd.uikit.business.chatroom.fragment.ChatRoomMessageFragment;
import com.qysd.uikit.business.chatroom.viewholder.ChatRoomMsgViewHolderBase;
import com.qysd.uikit.business.chatroom.viewholder.ChatRoomMsgViewHolderFactory;
import com.qysd.uikit.business.contact.selector.activity.ContactSelectActivity;
import com.qysd.uikit.business.preference.UserPreferences;
import com.qysd.uikit.business.session.activity.P2PMessageActivity;
import com.qysd.uikit.business.session.activity.TeamMessageActivity;
import com.qysd.uikit.business.session.audio.MessageAudioControl;
import com.qysd.uikit.business.session.emoji.StickerManager;
...
import com.qysd.uikit.business.session.viewholder.MsgViewHolderFactory;
import com.qysd.uikit.business.team.activity.AdvancedTeamInfoActivity;
import com.qysd.uikit.business.team.activity.NormalTeamInfoActivity;
import com.qysd.uikit.common.util.log.LogUtil;
import com.qysd.uikit.common.util.storage.StorageType;
import com.qysd.uikit.common.util.storage.StorageUtil;
import com.qysd.uikit.common.util.sys.ScreenUtil;
import com.qysd.uikit.impl.cache.ChatRoomCacheManager;
import com.qysd.uikit.impl.cache.DataCacheManager;
import com.qysd.uikit.impl.customization.DefaultContactEventListener;
import com.qysd.uikit.impl.customization.DefaultP2PSessionCustomization;
import com.qysd.uikit.impl.customization.DefaultRecentCustomization;
import com.qysd.uikit.impl.customization.DefaultTeamSessionCustomization;
import com.qysd.uikit.impl.provider.DefaultChatRoomProvider;
import com.qysd.uikit.impl.provider.DefaultContactProvider;
import com.qysd.uikit.impl.provider.DefaultRobotProvider;
import com.qysd.uikit.impl.provider.DefaultTeamProvider;
import com.qysd.uikit.impl.provider.DefaultUserInfoProvider;
import com.qysd.uikit.support.glide.ImageLoaderKit;
