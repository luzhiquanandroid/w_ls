package com.qysd.uikit.business.team.activity;
...
import com.qysd.uikit.business.contact.core.item.ContactIdFilter;
...
import com.qysd.uikit.business.session.helper.MessageListPanelHelper;
import com.qysd.uikit.business.team.activity.lawtree.AddQunLiaoEventBusBean;
import com.qysd.uikit.business.team.activity.lawtree.AddQunPersonActivity;
import com.qysd.uikit.business.team.activity.lawtree.ZhuangRangQunActivity;
import com.qysd.uikit.business.team.activity.lawtree.ZrQunLiaoEventBusBean;
import com.qysd.uikit.business.team.activity.lawtree.search.AddQunLiaoEventBusBeanAdd;
import com.qysd.uikit.business.team.activity.lawtree.search.SearchMessageActivity;
import com.qysd.uikit.business.team.adapter.TeamMemberAdapter;
import com.qysd.uikit.business.team.adapter.TeamMemberAdapter.TeamMemberItem;
import com.qysd.uikit.business.team.helper.AnnouncementHelper;
import com.qysd.uikit.business.team.helper.TeamHelper;
import com.qysd.uikit.business.team.model.Announcement;
import com.qysd.uikit.business.team.ui.TeamInfoGridView;
import com.qysd.uikit.business.team.viewholder.TeamMemberHolder;
import com.qysd.uikit.common.activity.ToolBarOptions;
import com.qysd.uikit.common.activity.UI;
import com.qysd.uikit.common.adapter.TAdapterDelegate;
import com.qysd.uikit.common.adapter.TViewHolder;
import com.qysd.uikit.common.media.picker.PickImageHelper;
import com.qysd.uikit.common.ui.dialog.DialogMaker;
import com.qysd.uikit.common.ui.dialog.EasyAlertDialogHelper;
import com.qysd.uikit.common.ui.dialog.MenuDialog;
...
import com.qysd.uikit.common.util.sys.TimeUtil;
...
public class AdvancedTeamInfoActivity extends UI implements
     ...
     * 新增的控件
     */
    private TextView tv_team_member;//人员数量
    private RecyclerView recycler_view;//群成员列表
    private RelativeLayout rl_add_new_member;//添加新成员
    private RelativeLayout rl_qun_nicheng;//群昵称
    private TextView tv_qun_nicheng;//群昵称显示
    private RelativeLayout rl_xiaoxi_state;//消息免打扰
    private ImageView iv_xiaoxi_state;//消息图标
    private TextView tv_tc, tv_zhuanrang_tc;//退出群聊 转让并退出群聊
    private RelativeLayout rl_liaotian_jilu;//查看聊天记录
    private RelativeLayout rl_clear_message;//清空消息记录
    private static int STATE = 0;//消息状态
    private Bundle bundle = new Bundle();
    private RelativeLayout rl_qun_detail;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 1; i < dataSource.size(); i++) {
            Log.e("lzqqq", dataSource.get(i).getAccount());
        }

        if (team.getMessageNotifyType().getValue() == 0) // All(0),Manager(1),Mute(2);
        {
            iv_xiaoxi_state.setImageResource(R.drawable.ic_open);
        } else {
            iv_xiaoxi_state.setImageResource(R.drawable.ic_close);
        }

        //转移群
        tv_zhuanrang_tc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ArrayList<String> accountList = new ArrayList<>();
                for (int i = 1; i < memberAccounts.size(); i++) {
                    accountList.add(memberAccounts.get(i));
                }
                Intent intent = new Intent(AdvancedTeamInfoActivity.this, ZhuangRangQunActivity.class);
                bundle.putString("teamId", teamId);
                bundle.putStringArrayList("accountList", accountList);
    ...
    private void findViews() {
        tv_team_info = findViewById(R.id.tv_team_info);
        rl_qun_detail = findViewById(R.id.rl_qun_detail);
        rl_liaotian_jilu = findViewById(R.id.rl_liaotian_jilu);
        tv_tc = findViewById(R.id.tv_tc);
        tv_zhuanrang_tc = findViewById(R.id.tv_zhuanrang_tc);
        iv_xiaoxi_state = findViewById(R.id.iv_xiaoxi_state);
        rl_xiaoxi_state = findViewById(R.id.rl_xiaoxi_state);
        rl_qun_nicheng = findViewById(R.id.rl_qun_nicheng);
        tv_qun_nicheng = findViewById(R.id.tv_qun_nicheng);
        tv_team_member = findViewById(R.id.tv_team_member);
        recycler_view = findViewById(R.id.recycler_view);
        rl_add_new_member = findViewById(R.id.rl_add_new_member);
        rl_add_new_member.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ArrayList<String> accountList = new ArrayList<>();
                ...
                Intent intent = new Intent(AdvancedTeamInfoActivity.this, AddQunPersonActivity.class);
                bundle.putStringArrayList("accountList", accountList);
                bundle.putInt("teamNum", team.getMemberCount());
                intent.putExtra("all", bundle);
                startActivity(intent);
            }
        });
        rl_qun_nicheng.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mUpdateNiCheng();
            }
        ...
        rl_xiaoxi_state.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                switch (STATE) {
                    case 0:
                        ...
                        iv_xiaoxi_state.setImageResource(R.drawable.ic_close);
                        AdvancedTeamInfoActivity.STATE = 1;
                        break;
                    case 1:
                        type = TeamMessageNotifyTypeEnum.All;
                        iv_xiaoxi_state.setImageResource(R.drawable.ic_open);
                        AdvancedTeamInfoActivity.STATE = 0;
                        break;
                }
        ...
        rl_liaotian_jilu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                MessageHistoryActivity.start(AdvancedTeamInfoActivity.this,
//                        teamId, SessionTypeEnum.Team);
                SearchMessageActivity.start(AdvancedTeamInfoActivity.this,
                        teamId, SessionTypeEnum.Team);
            }
        });
        rl_clear_message = findViewById(R.id.rl_clear_message);
        rl_clear_message.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        rl_qun_detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AdvancedTeamMemberActivity.startActivityForResult(AdvancedTeamInfoActivity.this, teamId, REQUEST_CODE_MEMBER_LIST);
            }
    ...
    private void updateTeamInfo(final Team t) {
        ...
        if (team == null) {
            ...
            setTitle("");
            tv_team_info.setText(team.getName());
        }
        ...
        tv_team_member.setText(team.getMemberCount() + "人");
    ...
    private void updateTeamBusinessCard(List<TeamMember> m) {
        for (TeamMember teamMember : m) {
            if (teamMember != null && teamMember.getAccount().equals(NimUIKit.getAccount())) {
                ...
                tv_qun_nicheng.setText(teamMember.getTeamNick() != null ? teamMember.getTeamNick() : "");
            }
        }
    }
    ...
    private void updateAuthenView() {
        if (isSelfAdmin || isSelfManager) {
            ...
            tv_zhuanrang_tc.setVisibility(View.VISIBLE);
            ...
            tv_zhuanrang_tc.setVisibility(View.GONE);
...
//        }
        ...
        tv_team_member.setText(count + "人");
    }
    ...
    private void onTransferTeam() {
        ...
        startActivity(new Intent(this, AddQunPersonActivity.class));
        //-------------demo 转移群---------------//
    ...
    private void setBusinessCard(final String nickname) {
        ...
        NIMClient.getService(TeamService.class).updateMemberNick(teamId, NimUIKit.getAccount(), nickname).setCallback(new RequestCallback<Void>() {
            ...
            public void onSuccess(Void param) {
                ...
                tv_qun_nicheng.setText(nickname);
     ...
     * 弹出修改备注对的对话框
     */
    private Dialog mUpdateNiCheng = null;

    public void mUpdateNiCheng() {
        mUpdateNiCheng = new Dialog(this, R.style.AlertDialogStyle);
        View view = View.inflate(this, R.layout.dialog_update_nicheng, null);
        final EditText et_nicheng = view.findViewById(R.id.et_nicheng);
        view.findViewById(R.id.tv_query).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (StringUtil.isEmpty(et_nicheng.getText().toString().trim())) {
                    Toast.makeText(AdvancedTeamInfoActivity.this, "昵称不能为空", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    setBusinessCard(et_nicheng.getText().toString().trim());
                }
                mUpdateNiCheng.dismiss();
                mUpdateNiCheng = null;
            }
        });
        mUpdateNiCheng.setContentView(view);
        mUpdateNiCheng.setCanceledOnTouchOutside(true);
        mUpdateNiCheng.getWindow().setBackgroundDrawableResource(R.color.transparent);
        mUpdateNiCheng.getWindow().setLayout(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        mUpdateNiCheng.show();
    }


    @Subscribe(threadMode = ThreadMode.MAIN)
    public void getAddQunLiaoSelectPerson(AddQunLiaoEventBusBeanAdd data) {
        if ("ADD".equals(data.getType())) {
            ArrayList<String> accounts = new ArrayList<>();
            for (int i = 0; i < data.getSelectList().size(); i++) {
                accounts.add(data.getSelectList().get(i).getUserId());
            }
            if (accounts != null && !accounts.isEmpty()) {
                inviteMembers(accounts);
            }
        }
    }

    @Subscribe(threadMode = ThreadMode.MAIN)
    public void getZrQunLiaoSelectPerson(ZrQunLiaoEventBusBean data) {
        Log.e("lzq zr", data.getType() + "---" + data.getAccount());
        if ("ZR".equals(data.getType())) {
            transferTeam(data.getAccount());
            quitTeam();
        }
    }
}
